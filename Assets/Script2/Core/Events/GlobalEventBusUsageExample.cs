...
namespace Script2.Core.Examples
{
    /// <summary>
    ...
    public class GlobalEventBusUsageExample : MonoBehaviour
    {
        ...
        {
            // ✅ CORRETTO: Subscribe in OnEnable (o Start/Awake)
        ...
        {
            // ✅ CRITICO: Sempre unsubscribe in OnDisable/OnDestroy!
            // Senza questo → MEMORY LEAK quando GameObject viene distrutto
        ...
        private void HandleResourceCollected(ResourceCollectedEvent evt)
        {
            ...
            // NO dipendenze dirette su altri Manager!
        }
        ...
        // ✅ CORRETTO: Più componenti possono subscribere allo stesso evento
