...
{
    /// <summary>
    /// Definizioni centralizzate di tutti gli eventi del gioco.
    /// Pattern: Struct-based events (zero GC allocation, type-safe).
    /// NOTA: Usare readonly struct per prevenire modifiche accidentali.
    /// </summary>
