...
{
	/// <summary>
	/// Test EditMode end-to-end per il SaveSystem.
	...
	public class SaveSystemRoundtripTests
	{
		...
		#region Validazione GameSaveData
		...
		#region JsonSaveSystem I/O con Try/Catch
		...
		#region OfflineProgressCalculator 
